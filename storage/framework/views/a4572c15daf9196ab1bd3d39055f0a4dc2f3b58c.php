        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h3>Salary & Allowance Payment Report: <?php echo e($date); ?></h3>
                    <h5 style="color:#363636">Balance Start Date: <?php echo e($bsdatex); ?></h5>
                    <hr>
                    <form method="POST" action="/salary_allowReport">
                        <?php echo csrf_field(); ?>
                    ...
                    <div class="table-responsive">
                        ...
                        <?php for($i=0;$i< count($investorx);$i++): ?>
                            <tr>
                                <td colspan="5" align="center" style="font-weight: bold; font-size: 25px;background-color: #c1a878;"><?php echo e(ucfirst($investorx[$i])); ?></td><!--investor names-->
                            </tr>
                            ...
                            <?php for($j=0;$j< count($datesx);$j++): ?> 
                                                ...
                                                <td>
                                                    ...
                                                    <?php if($k==0): ?>
                                                        <?php $__currentLoopData = $invx; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $in): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($in->username==$investorx[$i]&&$in->date==$datesx[$j]): ?>
                                                                <?php if($pos==0): ?>
                                                                    <?php echo e($in->amt); ?>
                                                    ...
                                                    <?php elseif($k==1): ?>
                                                        ...
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <?php elseif($k==2): ?>
                                                        <?php $__currentLoopData = $payoffx; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $in): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($in->username==$investorx[$i]&&$in->date==$datesx[$j]): ?>
                                                                <?php if($pos==0): ?>
                                                                    <?php echo e($in->amt); ?>
                                                        ...
                                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                    <?php else: ?>
                                                        <?php $__currentLoopData = $rpayoffx; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $in): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if($in->username==$investorx[$i]&&$in->date==$datesx[$j]): ?>
                                                                <?php if($pos==0): ?>
                                                                    <?php echo e($in->amt); ?>
                                ...
                                <tr>
                                    <td colspan="3" align="right" style="font-weight: bold;">
                                        Total Salary + Allowance Paid:
                                    </td>
                                    <?php if($profit>=0): ?>
                                        <td colspan="2" align="left" style="font-weight: bold; background-color:#3ded97;">
                                            <?php echo e($profit); ?>

                                        </td>
                                    <?php else: ?>
                                        <td colspan="2" align="left" style="font-weight: bold; background-color:#f08080;">
                                            <?php echo e($profit); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\folkscafe\resources\views//salary_allowReport.blade.php ENDPATH**/ ?>