...
<div class="container">
    ...
    <form method="POST" action="/products">
        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <h3><b>Products Shopping Entry</b></h3>
                <div class=" row justify-content-end">
                    <a class="btn btn-link" href="/menu/pd">Add/Remove Products</a>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\folkscafe\resources\views//products.blade.php ENDPATH**/ ?>