        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h3>Investments & Payoff Report: <?php echo e($date); ?></h3>
                    <h5 style="color:#363636">Balance Start Date: <?php echo e($bsdatex); ?></h5>
                    <hr>
                    <form method="POST" action="/invpayReport">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\folkscafe\resources\views//invpayReport.blade.php ENDPATH**/ ?>