        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h3>Other Cash INs Entry</h3>
                    <hr>
                    <form method="POST" action="/cin_others">
                        ...
                        <div class="form-group form-row">
                            <div class="col-md-6">
                                <label for="inv">Received From</label>
                                ...
                                <a class="btn btn-link" href="/cin_list">Add/Remove Cash Source</a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp\www\folkscafe\resources\views//cin_others.blade.php ENDPATH**/ ?>