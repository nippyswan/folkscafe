        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h3>Salary & Allowance Payment Report: {{$date}}</h3>
                    ...
                    <div class="table-responsive">
                        ...
                        @for($i=0;$i< count($investorx);$i++)
                            <tr>
                                <td colspan="5" align="center" style="font-weight: bold; font-size: 25px;background-color: #c1a878;">{{ucfirst($investorx[$i])}}</td><!--investor names-->
                            </tr>
                                        ...
                                        <!--show only non zero amt-->
                                            @if($fdatex[$i][$j][$k]!=0)
                                                <td>
                                                    ...
                                                    @if($k==0)
                                                        @foreach($invx as $in)
                                                            @if($in->username==$investorx[$i]&&$in->date==$datesx[$j])
                                                                @if($pos==0)
                                                                    {{$in->amt}}
                                                                    @php
                                                                    $profit+=$in->amt;
