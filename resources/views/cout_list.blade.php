        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h3>Add / Remove Expense Source</h3>
                    <hr>
                    <form method="POST" action="/cout_list">
                        @csrf
                    ...
                    <div class="row justify-content-end">
                        <a class="btn btn-link" href="/cout_listRestore">
                            Show Deleted Expense Sources
                        </a>
                    </div>
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td >
                                    ...
                                    <a href="/cout_list/{{{$inv->name}}}" onclick="return cnf()">
