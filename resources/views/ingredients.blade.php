...
@section('content')
@if(Session::has('combo')) <div class="alert alert-warning"> {{Session::get('combo')}} </div> @endif
                    ...
                    <div class="card-body"> 
                        ...
                        <div class="form-group form-row justify-content-end">
                            <div class="col-md-3" class="form-control">
                                <button type="submit" onclick="return bsubmit('{{$menulist}}')" class="btn btn-secondary">
                                    Submit
                                </button>
                            </div>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters" style="height: 110px;">
                                        <div class="col-12 p-0" style="background-color: grey;" >
                                            ...
                                            <img src="/storage/ingredients/{{$ml->imgurl}}" style="height: 110px; max-height: 110px; margin-left: auto; margin-right: auto; display: block;" class="img-fluid">
