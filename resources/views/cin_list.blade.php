        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h3>Add / Remove Cash Source</h3>
                    <hr>
                    <form method="POST" action="/cin_list">
                        @csrf
                    ...
                    <div class="row justify-content-end">
                        <a class="btn btn-link" href="/cin_listRestore">
                            Show Deleted Cash Sources
                        </a>
                    </div>
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                ...
                                <td >
                                    ...
                                    <a href="/cin_list/{{{$inv->name}}}" onclick="return cnf()">
