...
@section('content')
@if(Session::has('rcouterror')) <div class="alert alert-warning"> {{Session::get('rcouterror')}} </div> @endif
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h3>Other Cash OUTs Return Entry</h3>
                    <hr>
                    <form method="POST" action="/r_cout_others">
                        @csrf
