...
@section('content')
@if(Session::has('rcinerror')) <div class="alert alert-warning"> {{Session::get('rcinerror')}} </div> @endif
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h3>Other Cash INs Return Entry</h3>
                    <hr>
                    <form method="POST" action="/r_cin_others">
                        @csrf
